            ...
            [
                [
                    InlineKeyboardButton(
                        "➕ ❰ Aԃԃ Mҽ Tσ Yσυɾ Gɾσυρ ❱ ➕", url=f"https://t.me/AlexaEchoPlayerbot?startgroup=true")
                ]
...
@Client.on_message(commandpro(["/start", "/start@AlexaEchoPlayerbot", "/alive", "/BGT",  ".Kaal"]) & filters.group & ~filters.edited)
